...
3. Data processing and modelling scripts are documented in a [Google Colab Notebook](https://github.com/khinydnlin/false_fire_alarms_detection/blob/main/False_Fire_Alarms_Detection.ipynb). Click on the **Google Colab** icon at the top of the notebook to view the entire document.
